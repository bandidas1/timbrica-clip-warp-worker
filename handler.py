...
class _Encoder:
    ...
    def __init__(self, w, h, fps, mark, out=None):
        ...
        не умеет (дублирует объекты), а площадки требуют именно такого размера —
        Spotify Canvas для 9:16 документирует 720×1280 и 1080×1920. Апскейл lanczos на выходе
